                ...
                <div class="tab-pane active show" id="tabCont1">
                    ...
                    <div class="card">
                        <div class="wrapper" dir="rtl" >
                            <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2" action="{{route('studants.store','test')}}" method="post">
                                @csrf
                                <!-- tab 0 -->
                                                        ...
                                                        <div class="tooltip-demo">
                                                            <div class="row bg" dir="rtl" data-aos="flip-right">
                                                                ...
                                                                text-align: center; color: black !important;">
                                                                    <h1 class="">إنـشـاء حـســاب طالب</h1>
                                                                    <hr>
                                                                </div>
                    
                                                            <div class="form-group col-md-6">
                                                                <label for="full_name">{{__('الاسم الكامل')}}</label>
                                                                <input type="text" class="form-control @error('full_name')  @enderror" name="full_name" id="full_name" value="{{ old('full_name') }}" required dir="ltr">
                                                                @error('full_name')
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="classes">{{__('الصف الدراسي')}}</label>
                                                                <select class="form-control @error('classes') is-invalid @enderror" name="classes" id="classes">
                                                                    <option>- - اختار صف دراس - -</option>
